"""Summarization middleware for Paper Notes.
...
class PreserveSummarySummarizationMiddleware(SummarizationMiddleware):
...
def create_summarization_middleware(
    ...
    **kwargs: Any,
    ...
    return PreserveSummarySummarizationMiddleware(model=model, **kwargs)
