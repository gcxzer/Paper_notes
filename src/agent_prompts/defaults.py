...
PAPER_NOTES_WRITING_WORKFLOW_GUIDANCE = (
    ...
    "annotations, or library/index status. When calling it, send one short retrieval query built from exact "
    ...
    "extracted image file/index. "
    "For broad, comparative, or multi-part requests, synthesize those needs into one compact keyword query. If "
