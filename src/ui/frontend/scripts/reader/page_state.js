...
const elements = {
  ...
  readerChatNotice: document.querySelector("#readerChatNotice"),
...
function readInitialDeepSeekThinkMode() {
  try {
...
function readInitialGptThinkMode() {
  try {
...
const readerState = {
  ...
  chatProjects: [],
  chatProjectsLoading: false,
  chatProjectMenuOpen: false,
  chatProjectScopeId: "",
  expandedChatProjectId: "",
