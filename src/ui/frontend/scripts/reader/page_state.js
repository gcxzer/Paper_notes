...
const elements = {
  ...
  readerDebugDialog: document.querySelector("#readerDebugDialog"),
  readerCloseDebugDialog: document.querySelector("#readerCloseDebugDialog"),
  readerRefreshDebugRuns: document.querySelector("#readerRefreshDebugRuns"),
  readerCleanupDebugRuns: document.querySelector("#readerCleanupDebugRuns"),
  readerCleanupDebugMenu: document.querySelector("#readerCleanupDebugMenu"),
  readerCopyDebugRun: document.querySelector("#readerCopyDebugRun"),
  readerDebugRunList: document.querySelector("#readerDebugRunList"),
  readerDebugRunDetail: document.querySelector("#readerDebugRunDetail"),
  readerDebugError: document.querySelector("#readerDebugError"),
